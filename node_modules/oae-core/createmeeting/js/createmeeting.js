    ...
    return function (uid) {
        ...
        var setUpVisibility = function() {
			$('#createmeeting-allmoderators').on('change', function() {
				if($(this).is(":checked")) {
					$('#createmeeting-waitmoderator').attr('disabled', true);
					//$('#createmeeting-waitmoderator').addClass('createmeeting-checkbox-disabled');
				} else {
					$('#createmeeting-waitmoderator').attr('disabled', false);
					//$('#createmeeting-waitmoderator').removeClass('createmeeting-checkbox-disabled');
				}
			});
        };
