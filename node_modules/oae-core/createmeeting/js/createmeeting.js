...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        /**
         * Load the `features` into this widget.
         */
        var setUpFeatures = function() {

            // Settings for feature "sessions may be recorded"
            if ( oae.api.config.getValue('oae-bbb', 'bbb', 'recording') ) {
                $('.createmeeting-record').removeClass('hidden');
                if ( oae.api.config.getValue('oae-bbb', 'bbb', 'recordingDefault') ) {
                    $('#createmeeting-record').prop('checked', 'checked');
                }
            }

            // Settings for feature "all users are moderators"
            if ( oae.api.config.getValue('oae-bbb', 'bbb', 'allModerator') ) {
                $('.createmeeting-allmoderators').removeClass('hidden');
                if ( oae.api.config.getValue('oae-bbb', 'bbb', 'allModeratorDefault') ) {
                    $('#createmeeting-allmoderators').prop('checked', 'checked');
                }
            }

            // Settings for feature "wait for moderator to join"
            if ( oae.api.config.getValue('oae-bbb', 'bbb', 'waitModerator') && ( !oae.api.config.getValue('oae-bbb', 'bbb', 'allModerator') || !oae.api.config.getValue('oae-bbb', 'bbb', 'allModeratorDefault') ) ) {
                $('.createmeeting-waitmoderator').removeClass('hidden');
                if ( oae.api.config.getValue('oae-bbb', 'bbb', 'waitModeratorDefault') ) {
                    $('#createmeeting-waitmoderator').prop('checked', 'checked');
                }
            }
