    ...
    return function (uid) {
        ...
        var setUpSetPermissions = function() {
            ...
            if (contextData.id === oae.data.me.id) {
                visibility = oae.api.config.getValue('oae-meetings', 'visibility', 'meeting');
            } else {
        ...
        var createMeeting = function() {
            ...
            var meetingTopic = $.trim($('#createmeeting-topic', $rootel).val());

            oae.api.meeting.createMeeting(displayName, meetingTopic, visibility, [], members, function (err, data) {
                ...
                if (!err) {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__MEETING_COULD_NOT_BE_CREATED__', 'createmeeting'),
                        'error');
                }
            });
        ...
        var setUpCreateMeetingModal = function() {
            ...
            $('#createmeeting-modal', $rootel).on('shown.bs.modal', function() {
                ...
                // Set focus to the meeting topic field
