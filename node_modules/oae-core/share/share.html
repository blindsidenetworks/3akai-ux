    ...
    <h4>
        {if count === 1}
            ...
            {elseif resourceType === 'meeting'}
                __MSG__SELECT_USERS_AND_GROUPS_TO_SHARE_MEETING_WITH__
            {/if}
        {else}
            ...
            {elseif resourceType === 'meeting'}
                __MSG__SELECT_USERS_AND_GROUPS_TO_SHARE_MEETINGS_WITH__
            {/if}
        {/if}
    </h4>
    ...
    {if !err}
        {if count === 1}
            {if mylibrary}
                ...
                {elseif resourceType === 'meeting'}
                    __MSG__MEETING_ADDED_SUCCESS__
                {/if}
            {else}
                {if resourceSubType === 'collabdoc'}
                ...
                {elseif resourceType === 'meeting'}
                    __MSG__MEETING_SHARED_SUCCESS__
                {/if}
            {/if}
        {else}
            {if resourceType === 'content'}
            ...
            {elseif resourceType === 'meeting'}
                __MSG__MEETINGS_SHARED_SUCCESS__
            {/if}
        {/if}
    {else}
        {if count === 1}
