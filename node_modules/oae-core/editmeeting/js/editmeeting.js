    ...
    return function (uid) {
        ...
        var setUpFeatures = function() {
            ...
            if ( oae.api.config.getValue('oae-bbb', 'bbb', 'recording') ) {
                $('.editmeeting-record').removeClass('hidden');
            }

            // Settings for feature "all users are moderators"
            if ( oae.api.config.getValue('oae-bbb', 'bbb', 'allModerator') ) {
                $('.editmeeting-allmoderators').removeClass('hidden');
            }

            // Settings for feature "wait for moderator to join"
            if ( oae.api.config.getValue('oae-bbb', 'bbb', 'waitModerator') && ( !oae.api.config.getValue('oae-bbb', 'bbb', 'allModerator') || !$('#editmeeting-allmoderators').is(":checked") ) ) {
                $('.editmeeting-waitmoderator').removeClass('hidden');
            }
