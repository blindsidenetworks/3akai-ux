                        ...
                        oae.api.meeting.getRecording(meeting.id, function(err, info) {
                            if ( !err  && info.returncode == 'SUCCESS' && info.recordings.length > 0) {
                                ...
                                for (var i=0; i<info.recordings.length; i++ ) {
                                    ...
                                    var html_meeting_recordings_table_tbody_tr = '<td>'+ i +'</td><td><a target="_blank" href="' + info.recordings[i].playback.format.url + '">' + info.recordings[i].name + '</a></td><td>'+ info.recordings[i].startTime +'</td><td>'+ info.recordings[i].endTime +'</td>';
                                    if ( meeting.isManager ) {
