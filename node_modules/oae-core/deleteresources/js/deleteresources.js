...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        // Variable that will keep track of the resourceType of the resource(s) being deleted (i.e. `content`, `folder`, `discussion`, `meeting`)
        ...
        var deleteResourceFromSystem = function(resource, callback) {
            ...
            } else if (resource.resourceType === 'meeting') {
                oae.api.meeting.deleteMeeting(resource.id, callback);
            }
        };
        ...
        var deleteResourceFromLibrary = function(resource, callback) {
            if (contextProfile.resourceType === 'folder') {
                ...
                oae.api.meeting.deleteMeetingFromLibrary(contextProfile.id, resource.id, callback);
            }
        };
        ...
        var gatherResourceProfiles = function() {
            ...
            if (resourceType === 'content') {
                ...
                resourceProfileFunction = oae.api.meeting.getMeeting;
            }
        ...
        var setUpDeleteResourcesModal = function() {
            $(document).on('click', '.oae-trigger-deleteresources', function() {
                ...
                // will tell us what type of resource is being deleted (i.e., `content`, `folder`, `discussion`, `meeting`)
